...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="topsalescarousel.css" />
        <script src="topsalescarousel.js"></script>
    </head>
    <body>
        <div class="container-fluid">
            <h1 class="text-center mb-3">Top Sales</h1>
            <hr class="hr-1" />
            <div id="topsalesCarousel" class="carousel slide" data-ride="carousel">
                ...
                <a class="carousel-control-prev" href="#topsalesCarousel" role="button" data-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
                </a>
                <a class="carousel-control-next" href="#topsalesCarousel" role="button" data-slide="next">
